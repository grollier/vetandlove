    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.CharField(blank=True, max_length=240)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cliente.Cliente')),
            ],
        ),
        migrations.CreateModel(
            name='Raza',
        ...
        migrations.AddField(
            model_name='mascota',
            name='owner',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='mascota.MascotaOwner'),
        ),
        migrations.AddField(
            model_name='mascota',
            name='raza',
