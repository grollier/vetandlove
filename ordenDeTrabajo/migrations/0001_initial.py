# Generated by Django 2.0.5 on 2018-06-05 06:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orden_cliente', to='cliente.Cliente')),
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ordenDeTrabajo.Estado')),
                ('mascota', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orden_mascota', to='mascota.Mascota')),
            ],
        ),
        migrations.CreateModel(
            name='Servicio',
